...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
        ...
        public SuperAdventure()
        {
            ...
            //The following lines configure the dgvInventory datagrid view

            //Don't show row haeders and don't automatically generate the data grid columns
            ...
            //Configure the columns of the datagridview
        ...
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            // Determine the amoumnt of damage to do to the monster
            int damageToMonster = RandomNumberGenerator.NumberBetween(currentWeapon.MinimumDamage, currentWeapon.MaximumDamage);

            // Apply the damage to themonster's CurrentHitPoints
            ...
            if (_currentMonster.CurrentHitPoints <= 0)
            {
                ...
                List<InventoryItem> looteddItems = new List<InventoryItem>();
                ...
                foreach (LootItem lootItem in _currentMonster.LootTable)
                {
                    ...
                    {
                        looteddItems.Add(new InventoryItem(lootItem.Details, 1));
                    }
                }

                // If no items were randomly selected, then add the default loot items
                if (looteddItems.Count == 0)
                {
                    foreach (LootItem lootItem in _currentMonster.LootTable)
                    {
                ...
                foreach (InventoryItem inventoryItem in looteddItems)
                {
        ...
        {
            // Get the currently selected potion from the comboBbox
            HealingPotion potion = (HealingPotion)cboPotions.SelectedItem;

            // Add healing amount to the player's current hit points
            _player.CurrentHitPoints = (_player.CurrentHitPoints + potion.AmountToHeal);

            // CurrenHitPoints cannot exceed player's MaximumHitPoints
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            {
                // See if the player already has the quest, and if the've completed it
                ...
                else
                {
                    ...
                    // Add the quest to the player'squest list
                    _player.Quests.Add(new PlayerQuest(newLocation.QuestAvailableHere));
                }
            }


            // Does the loaction have a monster?
